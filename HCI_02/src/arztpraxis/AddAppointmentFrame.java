...
=======
		...
		gbl_appointmentPanel.columnWeights = new double[] { 0.0, 1.0,
				Double.MIN_VALUE };
		gbl_appointmentPanel.rowWeights = new double[] { 0.0, 0.0, 0.0, 0.0,
...
>>>>>>> a4ae663eeb17acaf7770a4f3cdd562c897c17b69
...
<<<<<<< HEAD
		...
		endZeitBoxModel.addElement("Endzeit ausw‰hlen..");
		...
		arztBoxModel.addElement("Arzt ausw‰hlen..");
		...
		patientBoxModel.addElement("Patient ausw‰hlen..");
...
=======
		...
		DefaultComboBoxModel<String> arztBoxModel = new DefaultComboBoxModel<String>();
		arztBoxModel.addElement("Arzt auswählenwählen..");

		Set<Doctor> doctors = dc.getDoctors();
		for (Doctor doctor : doctors) {
			arztBoxModel.addElement(doctor.getFirstName() + " "
					+ doctor.getLastName().toString());
		}
...
=======
		...
		Set<Patient> patients = dc.getPatients();
		for (Patient patient : patients) {
			patientBoxModel.addElement(patient.getFirstName() + " "
					+ patient.getLastName().toString());
		}
...
>>>>>>> a4ae663eeb17acaf7770a4f3cdd562c897c17b69
		...
		gbl_breakPanel.columnWeights = new double[] { 0.0, 1.0,
				Double.MIN_VALUE };
		gbl_breakPanel.rowWeights = new double[] { 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
		...
		gbl_absencePanel.columnWeights = new double[] { 0.0, 1.0,
				Double.MIN_VALUE };
		gbl_absencePanel.rowWeights = new double[] { 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
		...
		absencePanel.add(startZeitAbsenzenComboBox,
				gbc_startZeitAbsenzenComboBox);
